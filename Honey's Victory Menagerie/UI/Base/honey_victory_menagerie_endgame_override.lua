...
Styles = {
	...
	--VICTORY MENAGERIE ADDITIONS
	["VICTORY_RICHES"] = {
	RibbonIcon = "ICON_VICTORY_RICHES",
	Ribbon = "EndGame_Ribbon_Riches",
	RibbonTile = "EndGame_RibbonTile_Riches",
	Background = "EndGame_BG_Riches", 
	...
	Color = "COLOR_VICTORY_RICHES",
	},


	["VICTORY_CHARISMA"] = {
	RibbonIcon = "ICON_VICTORY_CHARISMA",
	Ribbon = "EndGame_Ribbon_Charisma",
	RibbonTile = "EndGame_RibbonTile_Charisma",
	Background = "EndGame_BG_Charisma", 
	Movie = "Culture.bk2", --good enough
	SndStart = "Play_Cinematic_Endgame_Culture", --good enough
